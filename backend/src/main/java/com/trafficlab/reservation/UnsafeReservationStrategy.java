...
@Service
public class UnsafeReservationStrategy implements ReservationStrategy {

    private final SeatRepository seatRepository;
    private final TransactionTemplate transactionTemplate;

    public UnsafeReservationStrategy(SeatRepository seatRepository, TransactionTemplate transactionTemplate) {
    ...
    public ReservationResult reserve(ReservationCommand command) {
        ...
        try {
            return transactionTemplate.execute(status -> {
                ...
                seatRepository.markStatusUnsafe(command.runId(), command.seatNumber(), SeatStatus.RESERVED);
